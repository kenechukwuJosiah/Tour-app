...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2VuZWNodWt3dSIsImEiOiJja3R1cHE1M24yMmt3MzBtcHF1bXl0OHFqIn0.3jtU5G_t8EPvU8Tu6mQiCw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/kenechukwu/cku32q3pf09if18o7pb5odvyu',
    scrollZoom: false // center: [7.085486, 6.2211308],
    // zoom: 10,
    // interactive: false,
...
var stripe = Stripe('pk_test_51JrrEOH9wwaU9HsNjivDTR2FSkA0IBpied4SMYtAB7aYwTJXpkco6ASH8WtnccDh2eyXaSn0ab5SbjVtDs2YG4xl00xQvDB7El');

// import Stripe from 'stripe';
// const stripe = new Stripe('pk_test_51JrrEOH9wwaU9HsNjivDTR2FSkA0IBpied4SMYtAB7aYwTJXpkco6ASH8WtnccDh2eyXaSn0ab5SbjVtDs2YG4xl00xQvDB7El');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.1:3300/api/v1/booking/checkout-session/".concat(tourId));
...
var formPasswordSettings = document.querySelector('.form-user-settings');
...
if (formPasswordSettings) formPasswordSettings.addEventListener('submit', /*#__PURE__*/function () {
